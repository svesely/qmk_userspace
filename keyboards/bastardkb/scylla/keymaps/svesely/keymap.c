...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_4x6_5( KC_ESC,  KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8,    KC_9,   KC_0,     KC_MINS,
                             ...
                             //-------------------------------------------------//-----------------------------------------------------------//
                              MT(MOD_LALT,KC_GRV),  KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K,    KC_L,   KC_SCLN,  KC_QUOT,
                             //-------------------------------------------------//-----------------------------------------------------------//
                              KC_LSFT, MT(MOD_LCTL,KC_Z), KC_X, KC_C, KC_V, MT(MOD_LGUI,KC_B),    KC_N, KC_M, KC_COMM, KC_DOT, MT(MOD_LSFT | MOD_RSFT,KC_BSLS),  MT(MOD_LCTL | MOD_RCTL,KC_SLSH),
                             //-------------------------------------------------//-----------------------------------------------------------//

                                MO(1), KC_DOWN, KC_BSPC, KC_RBRC,  KC_ENTER, KC_BSLS, KC_SPC,  KC_LBRC, KC_UP, MO(2)),

    [1] = LAYOUT_split_4x6_5(KC_TILD, KC_EXLM, KC_AT, KC_HASH, KC_DLR, LSG(KC_LBRC), LSG(KC_RBRC), KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,
                             //---------------------------------------------------------//-----------------------------------------------------------//
